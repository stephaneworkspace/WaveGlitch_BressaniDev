...
MainComponent::MainComponent() : fileLabel("", "No file loaded..."),
    ...
    oneButton.setBounds(20, 200, 80, 30);
    ...
    twoButton.setBounds(20 + (90 * 1), 200, 80, 30);
    ...
    fourButton.setBounds(20 + (90 * 2), 200, 80, 30);
    ...
    eighthButton.setBounds(20 + (90 * 3), 200, 80, 30);
    ...
    sixteenthButton.setBounds(20 + (90 * 4), 200, 80, 30);
    ...
    thirtytwoButton.setBounds(20 + (90 * 5), 200, 80, 30);
    ...
    sixtyfourthButton.setBounds(20 + (90 * 6), 200, 80, 30);
    ...
    onehundredtwentyeigthButton.setBounds(20 + (90 * 7), 200, 80, 30);
